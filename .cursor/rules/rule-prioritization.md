...
4. `task-decomposition.md` : Score 82 (si tâche complexe nécessitant décomposition)
5. `todo-completion.md` : Score 80

**Règles Importantes (Score 60-79) - Charger selon contexte :**
5. `task-decomposition.md` : Score 75 (si décomposition nécessaire mais pas critique)
6. `iteration-unified.md` : Score 75 (si itération nécessaire)
7. `persistent-execution.md` : Score 70 (si run autonome)
8. `preventive-validation.md` : Score 70 (si modification code)
9. `similar-code-detection.md` : Score 65 (si création/modification)
...
3. `client-consultant-oversight.md` : Score 85
4. `task-decomposition.md` : Score 85 (décomposition avec Background Agent et pensée séquentielle)
5. `todo-completion.md` : Score 85
6. `persistent-execution.md` : Score 80
7. `iteration-unified.md` : Score 80
...
class DynamicRulePrioritizer {
  ...
  async calculateCriticity(
    ...
    const criticalRules = {
      'simple': ['domain-rule'],
      'complex': ['domain-rule', 'senior-architect-oversight', 'client-consultant-oversight', 'todo-completion', 'task-decomposition'],
      'autonomous': ['domain-rule', 'senior-architect-oversight', 'client-consultant-oversight', 'todo-completion', 'persistent-execution', 'iteration-unified', 'task-decomposition']
    };
