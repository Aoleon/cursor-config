...
- `advanced-iteration-and-role-coordination.md` - Itérations avancées et coordination des rôles
- `task-decomposition.md` - Décomposition des tâches (décomposition, pensée séquentielle, Background Agent, listes structurées)
...
class RuleBundleManager {
  ...
  constructor() {
    ...
    this.bundles.set('autonomy', {
      ...
      priority: 85,
      useCases: ['complex-task', 'autonomous-run', 'iteration-needed', 'task-decomposition-needed'],
      autoLoad: true
    });
