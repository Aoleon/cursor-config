...
export default defineConfig({
  test: {
    ...
    // VITEST 4.0: verbose affiche maintenant en liste plate, utiliser 'tree' pour arborescent
    reporters: [
      'tree',     // ✅ Arborescent (remplace verbose en liste plate)
      'json'
    ],
    outputFile: './test-results/results.json',
    
    // Mock configurations
    // VITEST 4.0: deps.inline supprimé, utiliser deps.optimizer.web.include
    deps: {
      optimizer: {
        web: {
