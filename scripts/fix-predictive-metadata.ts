...
/**
 * Script de correction automatique des patterns metadata: { ... }); dans PredictiveEngineService.ts
 * 
...
function main() {
  console.log('🔧 Correction automatique des patterns metadata dans PredictiveEngineService.ts...\n');
